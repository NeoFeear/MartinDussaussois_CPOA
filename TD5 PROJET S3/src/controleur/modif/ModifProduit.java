...
public class ModifProduit implements Initializable
{
	...
	public void btnModif() throws Exception
	{
        ...
        {
        	dao.getProduitDAO().update(new Produit(1, nom, desc, tarif, visuel, categ));
